 ...
 *   https://datatables.net/download/#bs4/dt-1.10.18/b-1.5.6/b-flash-1.5.6
 *
 * Included libraries:
...
(function( $, window, document, undefined ) {
	...
	var DataTable = function ( options )
	{
		 ...
		 *      oTable.fnFilter('Webkit');
		 *      var data = oTable._('tr', {"Busqueda": "applied"});
		 *
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4/dt-1.10.18/b-1.5.6/b-flash-1.5.6",

...
@section('parent-content')
    <nav class="navbar navbar-expand-lg  navbar-dark navbar-custom ">
        <div class="container">
            <a href="{{ url('/') }}" class="navbar-brand text-dark ">
                <i class="fal {{ config('laracrud.icon') }} text-success"> </i> Gestion de horarios
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" id="userDropdown" class="nav-link text-dark dropdown-toggle" role="button" data-toggle="dropdown">
                            {{ auth()->user()->name }}
                        </a>

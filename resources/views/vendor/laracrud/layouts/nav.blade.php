@can('Admin')
    ...
    <li class="nav-item{!! request()->is('admin/docentes') ? ' active' : '' !!}">
        <a href="{{ route('admin.docentes') }}" class="nav-link text-dark">Docentes</a>
    </li>
    <li class="nav-item{!! request()->is('admin/fichas') ? ' active' : '' !!}">
        <a href="{{ route('admin.fichas') }}" class="nav-link text-dark">Fichas</a>
    </li>
    <li class="nav-item{!! request()->is('admin/competencias') ? ' active' : '' !!}">
        <a href="{{ route('admin.competencias') }}" class="nav-link text-dark">Competencias</a>
    </li>
    <li class="nav-item{!! request()->is('admin/ambientes') ? ' active' : '' !!}">
        <a href="{{ route('admin.ambientes') }}" class="nav-link text-dark">Ambientes</a>
    </li>
